...
async function rekapitulasiKoordinator(
  req: NextApiRequest,
  res: NextApiResponse
) {
  ...
  if (req.method === 'GET') {
    try {
      const response = await axios.get(
        `${API_BACKEND_HOST}/api/v1/rekapitulasi/koordinator`,
        {
          params: {
            ...
            tingkat_koordinator: req.query.tingkatKoordinator
          },
          headers: {
...
export default rekapitulasiKoordinator;
