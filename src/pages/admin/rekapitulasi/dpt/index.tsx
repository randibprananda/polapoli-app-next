...
import { useRekapitulasiDPT } from '../../../../swr/rekapitulasi';
...
const DPTPage = () => {
  ...
  const { data: DPTManualData, isLoading } = useRekapitulasiDPT(
    true,
  ...
  return (
    <>
      <Head>
        <title>Daftar Pemilih Tetap | Rekapitulasi</title>
      </Head>
      <HeaderPage
        title="Rekapitulasi Daftar Pemilih Tetap"
        action={
          <ExportToExcel
            element={<Button type="primary">Download Rekapitulasi</Button>}
            fileName="Rekapitulasi DPT"
            apiData={generateDataToExportRekapitulasi(DPTManualData, 'dpt')}
            onError={() =>
