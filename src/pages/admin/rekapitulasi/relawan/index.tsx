...
import { useRekapitulasiRelawan } from '../../../../swr/rekapitulasi';
...
const RelawanPage = () => {
  ...
  const { data: relawanData, isLoading } = useRekapitulasiRelawan(
    true,
  ...
  return (
    <>
      <Head>
        <title>Relawan | Rekapitulasi</title>
      </Head>
      <HeaderPage
        ...
        action={
          <ExportToExcel
            ...
            apiData={generateDataToExportRekapitulasi(relawanData, 'relawan')}
            onError={() =>
